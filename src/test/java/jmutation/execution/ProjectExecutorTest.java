...
class ProjectExecutorTest {
    ...
    void findJars() {
        ...
        List<String> expectedJars = List.of("slf4j-api-1.7.32.jar", "checker-qual-3.12.0.jar", "commons-io-2.11.0.jar",
                "plexus-utils-3.3.1.jar", "jsap-2.1.jar", "lidalia-lang-1.0.0.jar", "org.eclipse.jdt.core-3.27.0.jar",
                "junit-4.13.2.jar", "logback-classic-1.2.7.jar", "lidalia-slf4j-ext-1.0.0.jar", "maven-model-3.8.6.jar",
        ...
        assertTrue(expectedJars.size() == jarNames.size());
    }
}