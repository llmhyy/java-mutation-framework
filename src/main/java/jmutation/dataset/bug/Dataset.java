...
public enum Dataset {
    DEFECTS4J("Defects4J"),
    REGS4J("Regs4J"),
    MUTATION_FRAMEWORK("MutationFramework");
    ...
    public static String[] getProjectNames(Dataset datasetType) {
    ...
    public static int[] getBugNums(Dataset datasetType) {
        ...
        return new int[]{25, 1, 58, 19, 2, 184, 13, 27, 6, 13, 2, 8, 1, 2, 2, 1, 5, 7, 1, 1, 1, 2, 6, 2, 2, 2, 7, 2, 1, 4, 3, 1, 3, 2, 2, 1, 1, 3, 14, 2, 2, 1, 20, 2, 2, 53, 3, 3, 9, 3, 2, 1, 1, 5, 1, 2, 1, 1, 3, 1, 1, 2, 11, 31, 4, 1, 5, 3, 3, 2, 1, 1, 2, 3, 1, 1,
                1, 2, 3, 2, 2, 3, 2, 6, 11, 2, 2, 2, 2, 16, 2, 4, 1, 7, 1, 1, 1, 6, 7, 2, 13, 2, 3, 2, 3, 6, 3, 3, 8, 6, 3, 1, 2, 1};
    }
